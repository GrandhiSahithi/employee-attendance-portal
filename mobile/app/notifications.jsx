 ...
 * ====================
 * Lists the signed-in user's notifications (newest handled by the API),
 * lets them tap one to mark it read, or mark all as read at once.
 */
...
// Main Notifications screen: loads the list and marks items read on tap or via "Mark All as Read".
